...
const app = express();
//router 
const categorieRouter = require('./app/api/v1/categories/router');
...
const particaipantsRouter = require('./app/api/v1/participants/router');
...
app.use(`${v1}/cms`, categorieRouter);
...
app.use(`${v1}`, particaipantsRouter);
